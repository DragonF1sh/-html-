...
<body>
    <div class="container blue">
        <div class="col red">
            <!-- photo div -->
            <div class="row green mx-auto" style="width: 35%;">
                <a
                    href="https://www.google.com/search?q=baby+yoda&rlz=1C1GCEA_enCA867CA867&source=lnms&tbm=isch&sa=X&ved=2ahUKEwj978rOhaDmAhWSHjQIHcoPB7IQ_AUoAXoECA8QAw&biw=1440&bih=757&safe=active&ssui=on">
                    <img src="https://specials-images.forbesimg.com/imageserve/5de55fa3c283810006a371f3/960x0.jpg?fit=scale"
                        width="100%">
                </a>
            </div>
            <!-- pharagraph div -->
            <div class="row green mx-auto text-center" style="width: 100%;">
                <p>
                    This is baby yoda. He is the best thing from 2019. I dont really know why i chose to have him at the
                    top of my websight, but i did so its stuck like that cause im lazy. ^_^
                </p>
            </div>
        </div>
        <div class="col red">
        ...
        <div class="row red mx-auto" style="width: 100%;">
            <!-- contact div -->
            <div class="col orange">
                ...
                <div id="name" class="col-sm">
                    <form action="website.php">
                        ...
                        Phone Number:<br>
                        <input type="text" name="email" placeholder="Ex: 800-800-8000" style="width: 75%;"><br>
                        message:<br>
        ...
        <div class="col red">
            ...
            <div class="row black" style="width: 100%; text-align: center;">
                ...
                <div class="col">
                    <br><br>
                    <h4>nothing</h4><br>
                    <p>this is nothing till i make it something :)</p>
                </div>
                <!--  -->
                <div class="col">
...
<?php
    ...
    if($name && $email && $phoneNumber && $messege) {
        $query = $conection->prepare("INSERT INTO websiteContact name, email, phoneNumber, messege) VALUES (?, ?, ?, ?)");
        $query->bind_param("ssss", $name, $email, $phoneNumber, $messege);
        $query->execute();
